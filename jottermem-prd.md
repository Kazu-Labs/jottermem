...
- **App / browse-and-edit UI** — not built. The files are meant to be opened in any text editor / Drive's own UI in the meantime; a dedicated app is still open scope.
